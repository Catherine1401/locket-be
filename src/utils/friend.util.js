...
export const isSenderRequest = async (myId, toUserId) => {
  const friendRequest = await getFriendRequest(myId, toUserId);

  return !!friendRequest;
};

export const isReceiverRequest = async (myId, fromUserId) => {
  const friendRequest = await getFriendRequest(fromUserId, myId);
